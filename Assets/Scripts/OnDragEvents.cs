...
/// <summary>
/// Event f�r n�r ett objekt dras eller sl�pps
/// </summary>
public class OnDragEvents : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    void Update()
    {
        ...
        if(elvenArcher || shatteredSunCleric || stormpikeCommando)
        {
            ...
            float angle = 0;
            if (mousePos.x > worldStartPos.x) //till h�ger om mercenary
            {
                if (mousePos.y > worldStartPos.y) //�ver mercenary
                {
    ...
    /// <summary>
    /// Unitys inbyggda funktion f�r n�r en mus b�rjar dra n�gonting
    /// </summary>
    ...
    /// <summary>
    /// Unitys inbyggda funktion som itereras s� l�nge ett objekt dras
    /// </summary>
    /// <param name="eventData">Data kring eventet</param>
    ...
    /// <summary>
    /// Unitys inbyggda funktion f�r n�r ett objekt slutar dras
    /// </summary>
    /// <param name="eventData">Data kring eventet</param>
